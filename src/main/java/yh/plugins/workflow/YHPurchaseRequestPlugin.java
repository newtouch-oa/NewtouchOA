...
public class YHPurchaseRequestPlugin implements YHIWFPlugin{
	...
	public String before(HttpServletRequest request,
		...
		try {
		      ...
		      String reqId =  wf.getData(conn, flowId, runId, "申请单id");
		      
		      //修改状态为审核中，此时订单不能修改
		      String sql = "update erp_purchase_request set status = '"+StaticData.AUDITING+"' where id='"+reqId+"'";
