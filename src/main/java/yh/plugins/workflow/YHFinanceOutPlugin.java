...
public class YHFinanceOutPlugin implements YHIWFPlugin{
	...
	public String before(HttpServletRequest request,
		...
		try {
		      ...
		      String outId =  wf.getData(conn, flowId, runId, "应付单ID");
		      
		      //修改状态为审核中，此时应付单不能修改
		      String sql = "update erp_finance_out set status = '"+StaticData.AUDITING+"' where id='"+outId+"'";
