...
public class YHPageLoader {
  /**
   * log                                               
   */
  private static Logger log = Logger.getLogger(YHPageLoader.class);
  /**
   * 加载分页数据
   * @param dbConn
   * @param pageSize
   ...
   * @throws Exception
   */
  public static YHPageDataList loadPageList(Connection dbConn,
    ...
    String[] nameList = YHUtility.null2Empty(queryParam.getNameStr()).split(",");
