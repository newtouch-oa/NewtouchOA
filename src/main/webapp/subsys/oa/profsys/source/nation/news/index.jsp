...
function checkForm2() {
  ...
  if (checkForm()) {
    ...
    var requestURL = "<%=contextPath%>/yh/subsys/oa/profsys/source/nation/act/YHSourceNationAct/addNation.act";
    var json = getJsonRs(requestURL,pars);
    if (json.rtState == '1') { 
      alert(json.rtMsrg); 
      return ; 
    } else {
      window.location.href = "<%=contextPath%>/subsys/oa/profsys/source/nation/news/add.jsp";
    }
  }
}
function checkFCK() {
...
<table border="0" width="90%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td>
    <img src="<%=imgPath%>/notify_new.gif" align="absmiddle"><span class="big3"> 新建国家信息</span>&nbsp;&nbsp;
    </td>
  </tr>
</table>
<br>
