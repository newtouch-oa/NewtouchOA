...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=imgPath%>/folder_search.gif" align="middle">&nbsp;<b><span class="Big1" id="folderName"></span> - 文件查询结果</b>&nbsp;
    </td>
  </tr>
</table>
<br>
...
<div align="center" id="backDiv" style="display: none">
  <input type="button" value="返回" class="BigButton" onclick="location.href='<%=contextPath %>/subsys/oa/confidentialFile/showConfidentialFile/queryFile/query.jsp?seqId=<%=seqId%>'">
</div>
...
<br><center><input type="button" class="BigButton" value="返回" onclick="javascript:location.href='<%=contextPath %>/subsys/oa/confidentialFile/showConfidentialFile/queryFile/query.jsp?seqId=<%=seqId%>'"></center>
</div>
</body>
</html>