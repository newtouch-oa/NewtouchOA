...
function doInit(){
  ...
  var url = "<%=contextPath%>/yh/subsys/oa/asset/act/YHCpCptlInfoAct/applySelect.act";
   cfgs = {
    dataAction: url,
    container: "giftList",
    colums: [
  ...
  if(total <= 0){
    var table = new Element('table',{ "class":"MessageBox" ,"align":"center","width":"340" }).update("<tr>"
        + "<td class='msg info'><div class='content' style='font-size:12pt'>无空闲的固定资产</div></td></tr>"
        );
...
function toCao(cellData, recordIndex,columInde){
  ...
  return "<a href=\"#\" onclick=createNewWork('固定资产申请领用','固定资产名称=" + seqId
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=imgPath%>/asset.gif"><span class="big3"> 空闲的固定资产列表</span>
    </td>
    </tr>
    </table>
<br>
