...
function doInit(){
  ...
  var url = "<%=contextPath%>/yh/subsys/oa/finance/act/YHChargeExpenseAct/expenseSelect.act";
   cfgs = {
    ...
    colums: [
       ...
       {type:"text", name:"deptId", text:"部门名称", width: "5%",align:"center",sortDef:{type:0, direct:"asc"}},
       {type:"text", name:"chargeUser", text:"报销申请人", width: "5%",align:"center",sortDef:{type:0, direct:"asc"}},
  ...
  if(total <= 0){
    var table = new Element('table',{ "class":"MessageBox" ,"align":"center","width":"340" }).update("<tr>"
        + "<td class='msg info'><div class='content' style='font-size:12pt'>无符合条件的未报销支票</div></td></tr>"
        );
