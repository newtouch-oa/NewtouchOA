...
function doInit(){
  ...
  var url = "<%=contextPath%>/yh/subsys/oa/finance/act/YHChargeExpenseAct/expenseSelect.act";
   cfgs = {
    ...
    colums: [
       ...
       {type:"text", name:"isPrint", text:"打印状态",align:"center",width:"5%",render:toIsPrint},
  ...
  if(total <= 0){
    var table = new Element('table',{ "class":"MessageBox" ,"align":"center","width":"340" }).update("<tr>"
        + "<td class='msg info'><div class='content' style='font-size:12pt'>无符合条件的已作废支票</div></td></tr>"
        );
...
function applyExpense(){
  myleft=(screen.availWidth-800)/2;
  window.open("<%=contextPath%>/subsys/oa/finance/expense/charge/news/newexpense.jsp","","width=850,height=600,toolbar=no,menubar=no,scrollbars=yes,resizable=yes,location=no,left="+myleft+",top=50");
}
function addTr(){
...
<input type="hidden" value="3" name="expense" id="expense">
