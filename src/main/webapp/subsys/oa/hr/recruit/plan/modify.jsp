...
function deleteAttachBackHand(attachName,attachId,attrchIndex) { 
  var url = "<%=contextPath%>/yh/subsys/oa/hr/recruit/plan/act/YHHrRecruitPlanAct/delFloatFile.act?delAttachId=" + attachId + "&seqId=<%=seqId%>";
...
<br>
<form enctype="multipart/form-data" action="<%=contextPath%>/yh/subsys/oa/hr/recruit/plan/act/YHHrRecruitPlanAct/updateRecruitPlanInfo.act"  method="post" name="form1" id="form1" onsubmit="">
   ...
   <tr>
    ...
    <tr align="center" class="TableControl">
      <td colspan=4 nowrap>
        ...
        <input type="button" value="返回" class="BigButton" onClick="location='<%=contextPath %>/subsys/oa/hr/recruit/plan/manage.jsp'">
      </td>
    </tr>
  </table>
</form>
