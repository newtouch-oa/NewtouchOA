...
var requestUrl = contextPath + "/yh/subsys/oa/hr/manage/reinstatement/act/YHOrgSelect2Act";
function getAccord(){
  var data = {
  panel:'left',
...
function getRole(){
  $(roleIndex).update("");
  var url = contextPath + "/yh/subsys/oa/hr/manage/reinstatement/act/YHRoleSelectAct/getRoles.act";
  if (moduleId) {
    url += "?moduleId=" + moduleId + "&privNoFlag="+ privNoFlag ;
  }
  var json = getJsonRs(url);
