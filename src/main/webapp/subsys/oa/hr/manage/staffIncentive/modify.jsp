...
function doInit(){
  ...
  if(rtJson.rtState == "0"){
    ...
    if(data.incentiveTime){
      $("incentiveTime").value = data.incentiveTime.substr(0,10);
    }
    if(data.yearScore == "0"){
      $("yearScore").value = "";
    }
    ...
    getchangeType(data.incentiveType);
    fckContentStr = data.incentiveDescription;
...
function getchangeType(incentiveType){
  if(incentiveType == 1){
    $("addSpan").show();
    $("reduceSpan").hide();
  }
...
function deleteAttachBackHand(attachName,attachId,attrchIndex) { 
  var url = "<%=contextPath%>/yh/subsys/oa/hr/manage/act/YHHrStaffIncentiveAct/delFloatFile.act?delAttachId=" + attachId + "&seqId=<%=seqId%>";
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td><img src="<%=imgPath %>/notify_new.gif" align="middle"><span class="big3"> 编辑奖惩信息</span>&nbsp;&nbsp;
    </td>
  </tr>
</table>
<br>
<form enctype="multipart/form-data" action="<%=contextPath%>/yh/subsys/oa/hr/manage/act/YHHrStaffIncentiveAct/updateIncentiveInfo.act"  method="post" name="form1" id="form1" onsubmit="">
<table class="TableBlock" width="80%" align="center">
  ...
  <tr>
    ...
    <tr>
      ...
      <td class="TableData">
       <INPUT type="text" name="salaryMonth" id="salaryMonth" class=BigInput size="8" maxlength = "7" value="">
      </td>
    </tr>
    <tr>
   ...
   <tr>
    ...
    <tr align="center" class="TableControl">
      <td colspan=4 nowrap>
        ...
        <input type="button" value="返回" class="BigButton" onClick="location='<%=contextPath %>/subsys/oa/hr/manage/staffIncentive/manage.jsp'">
      </td>
    </tr>
  </table>
</form>
