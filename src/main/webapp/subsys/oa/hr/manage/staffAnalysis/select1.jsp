...
%>
	...
	String month=ton.substring(5,7);    
	//获取年的第一天和最后一天
...
function doSubmit1(){
 ...
 if(doCheck()){
  if(chose=='0'){
	  $('iframe').src= "<%=contextPath%>/subsys/oa/hr/manage/staffAnalysis/analysisList.jsp?deptId="+deptId+"&startDate="+startDate+"&endDate="+endDate+"&module="+module;
  ...
  var data = rtJson.rtData.data;
  $('iframe').src = "<%=contextPath%>/subsys/oa/hr/manage/staffAnalysis/analysis.jsp?deptId="+deptId+"&chose="+chose+"&data="+data;
  }
 }
}
function doCheck(){
...
<%if("HR_INFO".equals(module)) {%>
    <tr>
      ...
      <td class="TableData" nowrap   colspan="3">
         ...
         <input type="radio" name='SUMFIELD' id='SUMFIELD9' value="5" onClick="sel_change()"><label for="SUMFIELD9">在职状态</label>&nbsp;
...
<%} if(!"HR_RZ1".equals(module) && !"HR_LZ1".equals(module) && !"HR_DD1".equals(module)) {%>
    ...
    <tr>
      ...
      <td class="TableData" width="120">
         <input type="radio" name='MAP_TYPE' id='MAP_TYPE1' value="1" checked><label for="MAP_TYPE1">饼图</label>&nbsp;
      ...
      <td class="TableContent" width="80"> 所属部门：</td>
      <td class="TableData" >
...
<br><br>
<div align="center">
<iframe align="middle" width="90%" height="70%" src="analysis.jsp" id="iframe" frameborder="0" ></iframe>
</div>
</body>
</html>
