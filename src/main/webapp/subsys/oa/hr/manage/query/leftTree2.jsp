...
function loadData(){
	 $(index).update("");
	  tree = new DTree({bindToContainerId:index
	    , requestUrl:'<%=contextPath%>/yh/subsys/oa/hr/manage/staffInfo/act/YHHrStaffInfoAct/getPersonTree.act?MODULE_ID='+ 10 + '&privNoFlag=1&id='
	    , isOnceLoad:false
...
function showStaffInfo(personId){
	var parent = window.parent.addressmain;
	parent.location = "<%=contextPath%>/subsys/oa/hr/manage/query/showStaffInfo.jsp?personId=" + personId;
