...
<script type="text/javascript"  src="<%=contextPath%>/subsys/oa/hr/salary/manage/salFlow/js/recruitRequirementsLogic.js"></script>
...
function doInit(){
	...
	var url = "<%=contextPath%>/yh/subsys/oa/hr/salary/salFlow/act/YHHrSalFlowAct/getSalFlowDetail.act?seqId=<%=seqId%>";
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td><img src="<%=imgPath %>/notify_new.gif" align="middle"><span class="big3">编辑工资流程</span>&nbsp;&nbsp;
    </td>
  </tr>
</table>
<br>
<form enctype="multipart/form-data" action="<%=contextPath%>/yh/subsys/oa/hr/salary/salFlow/act/YHHrSalFlowAct/updateSalFlowInfo.act"  method="post" name="form1" id="form1" onsubmit="">
   ...
   <tr>
    ...
    <tr align="center" class="TableControl">
      <td colspan=4 nowrap>
        ...
        <input type="button" value="返回" class="BigButton" onClick="location='<%=contextPath %>/subsys/oa/hr/salary/manage/salFlow/manage.jsp'">
      </td>
    </tr>
  </table>
</form>
