  ...
  <input type="hidden" id="ITEM_COUNT" name="ITEM_COUNT" value="<%=listSalItem.size() %>">
	<tbody>
     ...
     <tr align="center" class="TableLine1">
       ...
       <td nowrap="" width="300px" align="center">
         <%=YHUtility.getFormatedStr(person.getAllBase(),1) %>
       </td>
     </tr>               
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">养老保险</td>
       <td nowrap="" width="300px" align="center">
         <%=YHUtility.getFormatedStr(person.getPensionBase(),1) %>
       </td>       
     </tr>  
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">单位养老</td>
       <td nowrap="" width="300px" align="center">
         <%=YHUtility.getFormatedStr(person.getPensionU(),1) %>
       </td>       
     </tr> 
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">个人养老</td>
       <td nowrap="" width="300px" align="center">
         <%=YHUtility.getFormatedStr(person.getPensionP(),1) %>
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">医疗保险</td>
       <td nowrap="" width="300px" align="center">
         <%=YHUtility.getFormatedStr(person.getMedicalBase(),1) %>
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">单位医疗</td>
       <td nowrap="" width="300px" align="center">
         <%=YHUtility.getFormatedStr(person.getMedicalU(),1) %>
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">个人医疗</td>
       <td nowrap="" width="300px" align="center">
         <%=YHUtility.getFormatedStr(person.getMedicalP(),1) %>
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">生育保险</td>
       <td nowrap="" width="300px" align="center">
         <%=YHUtility.getFormatedStr(person.getFertilityBase(),1) %>
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">单位生育</td>
       <td nowrap="" width="300px" align="center">
         <%=YHUtility.getFormatedStr(person.getFertilityU(),1) %>
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">失业保险</td>
       <td nowrap="" width="300px" align="center">
         <%=YHUtility.getFormatedStr(person.getUnemploymentBase(),1) %>
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">单位失业</td>
       <td nowrap="" width="300px" align="center">
         <%=YHUtility.getFormatedStr(person.getUnemploymentU(),1) %>
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">个人失业</td>
       <td nowrap="" width="300px" align="center">
         <%=YHUtility.getFormatedStr(person.getUnemploymentP(),1) %>
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">工伤保险</td>
       <td nowrap="" width="300px" align="center">
         <%=YHUtility.getFormatedStr(person.getInjuriesBase(),1) %>
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">单位工伤</td>
       <td nowrap="" width="300px" align="center">
         <%=YHUtility.getFormatedStr(person.getInjuriesU(),1) %>
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">住房公积金</td>
       <td nowrap="" width="300px" align="center">
         <%=YHUtility.getFormatedStr(person.getHousingBase(),1) %>
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">单位住房</td>
       <td nowrap="" width="300px" align="center">
         <%=YHUtility.getFormatedStr(person.getHousingU(),1) %>
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">个人住房</td>
       <td nowrap="" width="300px" align="center">
         <%=YHUtility.getFormatedStr(person.getHousingP(),1) %>
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">投保日期</td>
       <td nowrap="" width="300px" align="center">
         <%=person.getInsuranceDate() == null ? "" : person.getInsuranceDate()%>
       </td>       
     </tr>   
      <%} %>
     <tr align="center" class="TableHeader">
