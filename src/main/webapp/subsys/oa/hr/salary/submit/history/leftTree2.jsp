...
function getChildOrEdit(id){
	...
	if(id.indexOf('r') == -1){  
		...
		var url = "<%=contextPath%>/yh/subsys/oa/hr/salary/submit/act/YHHrSubmitAct/getSalItemIdUserAct.act?userId="+id+"&flowId="+window.parent.flowId+"&history=true";
...
function showStaffInfo(personId){
	...
	parent.location = "<%=contextPath%>/yh/subsys/oa/hr/salary/submit/act/YHHrSubmitAct/getSalItemIdUserAct.act?userId="+personId+"&flowId="+window.parent.flowId+"&history=true";
}
</script>
</head>
