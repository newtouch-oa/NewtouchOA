...
function ShowDialog(){    //id是传入后台的最佳答案的id 
  ...
  $("apply").style.left = ((parseInt(document.body.clientWidth) - parseInt($("apply").style.width))/2 )  + "px";
  

  $("apply").style.top  = 130 + "px";
...
function sealIdFunc(cellData, recordIndex, columIndex){
  ...
  return "<center><a href=\"javascript:doEdit("+seqId+");\">" + cellData + "</a></center>"
}
