...
function convert()
{
  ...
  if(isOpen == true)
  {
    ...
    //把内容上传到服务器
    var rtJson = getJsonRs(contextPath + "/yh/rad/docs/component/act/YHAIPAct/uploadAip.act",
...
<table class="TableList" width="80%" align="center">
  <tr>
    ...
    <td class="TableData">
      <input type="text" size=25 name="T_NAME" id="T_NAME">
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="TableControl" align="center" colspan=2>
      <input type="button"  value="保存模板文件"  class="SmallButtonC"  onclick="convert();">
    </td>
  </tr>
</table>
</body>
