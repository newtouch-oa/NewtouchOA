    ...
    <script type="text/javascript" src="crm/js/cus.js"></script>
  	<script language="javascript" type="text/javascript">
		...
		function tabReload(cusState){
			self.location.href="customAction.do?op=toListCustomers&range=${range}&cusState="+cusState;
		}
		function loadFilter(){
			if('${range}'=='1'){
    	...
    	<div id="contentbox">
        	<div id="title"><a class="refreshButton" href="javascript:void(0)" onClick="self.history.go(0)" title="重新载入页面"></a>&nbsp;CRM管理 > <c:if test="${range!=1}">我的</c:if><c:if test="${range==1}">全部</c:if>客户</div>
                ...
                <tr>
                    ...
                    <td>
                    	<a href="javascript:void(0)" onClick="cusPopDiv(1);return false;" class="newBlueButton">新建客户</a>
                    </td>
                </tr>
            </table>
