...
<html>
    ...
    <script type="text/javascript" src="crm/js/cus.js"></script>
  	<script language="javascript" type="text/javascript">
		...
		function tabReload(cusState){
			self.location.href="customAction.do?op=toMyListCustomers&range=${range}&cusState="+cusState;
		}
		function loadFilter(){
			if('${range}'=='1'){
		...
		function dataMapper(obj){
			...
			dataId = obj.corCode;
			var dblFunc="descPop('customAction.do?op=showMyCompanyCusDesc&corCode="+dataId+"')";
			var cusMark = "";
			if(obj.corTempTag=="0"){
			...
			var funcCol = "<img src='crm/images/content/detail.gif' onClick=\""+dblFunc+"\" class='hand' alt='查看详细'/>";
  ...
  <body>
    <div id="mainbox">
    	<div id="contentbox">
        	<div id="title"><a class="refreshButton" href="javascript:void(0)" onClick="self.history.go(0)" title="重新载入页面"></a>&nbsp;CRM管理 > <c:if test="${range!=1}">我的</c:if><c:if test="${range==1}">全部</c:if>客户</div>
  	   		<table class="mainTab" cellpadding="0" cellspacing="0">
                <tr>
                    <th>
                        <div id="tabType">
                         	<div id="tabType1" onClick="tabReload('2')">客户信息列表</div>
                            <c:if test="${range==1}"><div id="tabType4" onClick="tabReload('a')">全部</div></c:if>
                        </div>
                    </th>
                    <!--  
                    <td>
                    	<a href="javascript:void(0)" onClick="manageCusPopDiv(1);return false;" class="newBlueButton">新建客户</a>
                    </td>
                    -->
                </tr>
            </table>
            ...
            <div id="listContent">
             	<div class="listSearch">
                	<form style="margin:0; padding:0;" id="searchForm" onSubmit="loadList();return false;" >
                        ...
                        客户名称：<input style="width:110px" class="inputSize2 inputBoxAlign" type="text" id="corName" name="corName" onBlur="autoShort(this,100)"/>&nbsp;
                       ...
                       <br/>  地址：<input style="width:110px" class="inputSize2 inputBoxAlign" type="text" id="corAdd"  name="corAdd" onBlur="autoShort(this,50)"/>&nbsp;  
                   	  <c:if test="${range==1}">
                        ...
                        <td colspan="3" class="longTd">
                            <select class="inputBoxAlign inputSize2" id="country"  name="countryId" style="width:110px" onChange="getManageCityInfo('cou')">
                            ...
                            <select class="inputBoxAlign inputSize2" id="pro" name="provinceId" style="width:110px" onChange="getManageCityInfo('province')">
                            </select>&nbsp;
                            <select class="inputBoxAlign inputSize2" id="city" name="cityId" style="width:110px" >
                            </select>
                            <!--  
