                ...
                <tbody>
                    <tr>
                        ...
                        <td colspan="3" class="longTd">
                            <select class="inputBoxAlign inputSize2" id="country"  name="countryId" style="width:135px" onChange="getCityInfo('cou')">
                            ...
                            <select class="inputBoxAlign inputSize2" id="pro" name="provinceId" style="width:135px" onChange="getCityInfo('province')">
                            </select>&nbsp;
