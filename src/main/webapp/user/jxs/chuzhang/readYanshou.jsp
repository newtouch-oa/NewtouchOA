...
<table border="0" width="90%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td><img src="<%=imgPath%>/notify_new.gif" align="absmiddle"> 审批验收方案通知单&nbsp;&nbsp;    </td>
  </tr>
</table>
<br>
...
<input type="button" value="通过" onclick="window.close()" class="BigButton">
  <input type="button" value="不通过" onclick="window.close()" class="BigButton">
  </td>
  </tr> 
</table>·
</form>
