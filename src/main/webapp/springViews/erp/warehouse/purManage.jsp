...
function doInit(){
initTime();
     var url = "<%=contextPath %>/SpringR/warehouse/queryPurOut?status="+status+"&beginTime="+beginTime+"&endTime="+endTime;
	  var cfgs = {
	      dataAction: url,
	      ...
	      colums: [
	         ...
	         {type:"data", name:"code",  width: '15%', text:"采购订单单编号",render:recordCenterFunc,sortDef:{type:0, direct:"asc"}},    
	         {type:"data", name:"ppoCode",  width: '15%', text:"采购货单编号",render:recordCenterFunc,sortDef:{type:0, direct:"asc"}},    
...
if (checkForm()){
 ...
 window.location = "purManage.jsp?status="+statuss+"&beginTime="+beginTime+"&endTime="+endTime;
	 }
 }
	function checkForm(){
