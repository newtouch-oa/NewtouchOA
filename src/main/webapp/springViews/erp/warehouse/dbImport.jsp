...
function downCSVTemplet(){
	var downUrl = "<%=contextPath%>/yh/subsys/oa/asset/act/YHDbImportAct";
 ...
 <body class="bodycolor" topmargin="5">
  <table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
    <tr>
      <td class="Big"><img src="<%=imgPath%>/notify_new.gif"><span class="big3"> 导入库存信息</span><br>
      </td>
    </tr>
  </table>
  <br>
  ...
  <div align="center" class="Big1">
    <form name="form1" id="form1" action="<%=contextPath%>/yh/subsys/oa/asset/act/YHDbImportAct/importDb.act" method="post" enctype="multipart/form-data">
<table class="TableBlock" align="center" width="70%">  
 <tr class="TableData" align="center" height="30">
   ...
   <td width="400" align="left">
    <a href="#" onclick="downCSVTemplet();">库存信息模板下载 </a>
   </td>
 </tr>
 <tr class="TableData" align="center" height="30">
