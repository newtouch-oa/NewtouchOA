...
function doInit(){
initTime();
     var url = "<%=contextPath %>/SpringR/finance/fidShowDetial?fi_id=<%=fi_id%>&status="+status+"&beginTime="+beginTime+"&endTime="+endTime;
	  var cfgs = {
	      dataAction: url,
...
if (checkForm()){
 ...
 window.location = "fidShowDetial.jsp?status="+statuss+"&beginTime="+beginTime+"&endTime="+endTime+"&fi_id=<%=fi_id%>";
	 }
 }
	function checkForm(){
