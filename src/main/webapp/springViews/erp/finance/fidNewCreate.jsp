...
function getFIMsg(){
	var url = "<%=contextPath %>/SpringR/finance/getFIMsg?fi_id=<%=fi_id%>";
	jQuery.ajax({
	   type : 'POST',
	   url : url,
	   async:false,
   ...
   function doSubmitForm(formObject) {
	 ...
	 var para = "fi_id=<%=fi_id%>&code="+code+"&money="+money+"&bank_id="+bank_id
	 		   +"&paid_way="+paid_way+"&paid_date="+paid_date+"&person="+person+"&invoice_id="+invoice_id+"&remark="+remark;

	 var url="<%=contextPath %>/SpringR/finance/addFID?"+para;
