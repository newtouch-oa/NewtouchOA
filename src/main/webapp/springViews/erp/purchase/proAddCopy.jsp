	 ...
	 var url1 = "<%=contextPath %>/SpringR/productUnit/getList/"+new Date().getTime();
	  var unitId = jQuery("#unitId").val();
		 jQuery.ajax({
                   ...
                   option.innerHTML = item.unitName; 
	   ...
	   success : function(jsonData){   
		  if(jsonData != "-1"){
			...
			jQuery('#proName').val("");
	 		...
	 		var url="purQuery.jsp?shortName="+arr[0]+"&typeId="+arr[1]
	 		parentWindowObjs.location.assign(url);
			self.close();
		  }else if(jsonData == "2"){
		   	alert("更新成功");
		  }
...
<table class="TableBlock" width="55%" align="center">
     ...
     <tr>
      ...
      <td nowrap class="TableData">计量单位：</td>
       <td class="TableData" colspan="3">
        		<input type="hidden" name="unitId" id="unitId"  class="BigInput"  >
      ...
      <td nowrap class="TableData">产品所属大类：</td>
       <td class="TableData" colspan="3">
            <input type="hidden" name="styleId" id="styleId" style="width:130px;">
