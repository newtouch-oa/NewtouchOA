...
function getCusMsg(){
   ...
   function doSubmitForm(formObject) {
	 ...
	 var para = "fCode="+fCode+"&fdId="+fdId+"&ppd_code="+ppd_code+"&bank_id="+bank_id
	 ...
	 var url="<%=contextPath %>/SpringR/finance/updateOutDetail?"+para;
     ...
     <td nowrap class="TableData">出款操作人：</td>
      ...
      <td class="TableData" >
        <select id="bank_id" name="bank_id" class="BigInput">
	      ...
	      <td nowrap class="TableData">支付方式：</td>
	      <td class="TableData" >
