...
var id="<%=id%>";
	...
	function getLogisticsById(){
		var url = '<%=contextPath%>/SpringR/system/getLogisticsById?id=<%=id%>';
		jQuery.ajax({
			url:url,
			type:'POST',
   ...
   function doSubmitForm(formObject) {
	 ...
	 var logistics = jQuery('#name').val();
	 
	 var url="";
    	 url = "<%=contextPath %>/SpringR/system/editLogistics?logistics="+encodeURIComponent(logistics)+"&id="+id;
