     ...
     var url = "<%=contextPath %>/SpringR/saleOrder/custContact?cusId=<%=cusId%>";
	  var cfgs = {
	    ...
	    if(total){
	      ...
	      WarningMsrg('无符合条件的联系人信息','listDiv','msrg');
	    }
}
...
function opts(cellData, recordIndex, columIndex){
	...
	return "<center><a href=\"javascript:void(0)\" onclick=\"add('" + conName+"','"+conId +"','"+conPhone+"','"+conWorkPhone+"','"+conAdd+ "','"+conEmail+"');\" ><font color='red'>+添加</font></a></center>";
}
...
<div id="listRecords" style="width:100%">
