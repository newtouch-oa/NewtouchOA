...
function addUser(){
  ...
  var url = contextPath + "/yh/core/funcs/workflow/act/YHFlowRunAct/addUser.act";
...
function selectUser(){
  var Url = contextPath + "/core/funcs/workflow/flowrun/list/inputform/userSelect/MultiUserSelect.jsp?isSingle=true&flowId=<%=flowId%>&runId=<%=runId%>&prcsId=<%=prcsId%>&flowPrcs=<%=flowPrcs%>";
