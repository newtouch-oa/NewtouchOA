...
var toId = "<%=toId%>";
function doInit() {
  var url = contextPath + "/yh/core/funcs/workflow/act/YHFlowManageAct/getRemindInfo.act";
...
function remind() {
  if(CheckForm()) {
    var url = contextPath + "/yh/core/funcs/workflow/act/YHFlowManageAct/remindUser.act?sortId=<%=sortId%>&skin=<%=skin%>";
