...
<script type="text/javascript" src="<%=contextPath%><%=moduleContextPath %>/flowrun/manage/js/flowRunManager.js"></script>
...
function doInit(){ 
  ...
  var url =  contextPath + "<%=moduleSrcPath %>/act/YHMyWorkControlAct/getMyManagerWork1.act";
  cfgs = {
    dataAction: url, 
...
function loadFlowType(){
  var url = contextPath+'<%=moduleSrcPath %>/act/YHFlowManageAct/getFlowTypeJson.act?sortId='+ sortId;
...
<table id="flow_table" border="0" width="100%" height="60"  class="TableList" >
  <tr class=TableLine1>
  <td><img src="<%=imgPath %>/green_arrow.gif" align="absmiddle">请选择要监控的公文：
