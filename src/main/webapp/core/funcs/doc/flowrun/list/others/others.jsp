...
function LoadWindow(PRCS_ID_I){
  ...
  //仅允许委托当前步骤经办人
    ...
    var URL = contextPath + "/core/funcs/doc/flowrun/list/others/userSelectPrcs.jsp?flowId=<%=flowId%>&runId=<%=runId%>&prcsId=" + PRCS_ID_I+"&flowPrcs=<%=flowPrcs%>";
    var w = 250;
    var h = 300;
    var loc_y=loc_x=200;
    if (is_ie) {
  ...
  //按步骤设置的经办权限委托
    ...
    var Url = contextPath + "/core/funcs/doc/flowrun/list/others/MultiUserSelect.jsp?isSingle=true&flowId=<%=flowId%>&runId=<%=runId%>&prcsId=" + PRCS_ID_I+"&flowPrcs=<%=flowPrcs%>";
