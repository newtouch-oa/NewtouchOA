...
function outAllSelected() {
  var selectedOp = User.value.split(',')
  var selectedHo = UserOp.value;
  for(var i = 0 ; i < selectedOp.length ; i++){
    var selectedTr = $('TR-' + selectedOp[i]);
      if(selectedTr){
        var selectedTd = selectedTr.lastChild;
        selectedTd.isChecked = false;
...
//经办
function outSelected1(selectedOp) {
    var selectedTr = $('TR-' + selectedOp);
    if(selectedTr){
       var selectedTd = selectedTr.lastChild;
       selectedTd.isChecked = false;
       selectedTd.style.backgroundColor = "";
...
//主办
function outSelected2(selectedHo) {
  var selectedTr = $('TR-' + selectedHo);
  if(selectedTr){
     var selectedTd = selectedTr.firstChild;
     selectedTd.isChecked = false;
