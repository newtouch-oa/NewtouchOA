...
<table id="flow_table" border="0" width="100%" class="TableList"  style="clear:both;table-layout:fixed;" >
  <tr class="TableTr" id="flowTableHeader">
      <td  class="TableHeader"  nowrap align="center" width=300><b>文件标题</b></td>
      <td class="TableHeader"  nowrap align="center" width=80><b>拟稿人</b></td>
      <td class="TableHeader"  nowrap align="center" width=80><b>文号</b></td>
      <% //if("3".equals(type)){ %>
      <!-- <td class="TableHeader"  nowrap align="center" width=80><b>编号</b></td> -->
      <% //} %>
      <td class="TableHeader"  nowrap align="center" width=80><b>成文日期</b></td>
      <%if(!"3".equals(type)){ %>
      <td class="TableHeader"  nowrap align="center" width=60><b>密级</b></td>
      <%} %>
      <td class="TableHeader"  nowrap align="center" width=60><b>紧急程度</b></td>
      <!-- td class="TableHeader"  nowrap align="center" width=80><b>流程走向</b></td> -->
  <% if ("3".equals(type)) { %>
  <td  class="TableHeader" nowrap align="center" width=200><b>正文</b></td>
    <!-- <td  class="TableHeader" nowrap align="center" width=100><b>下一环节办理人</b></td>
    <td  class="TableHeader" nowrap align="center" width=100><b>流程走向</b></td> -->
    <td  class="TableHeader" nowrap align="center" width=100><b>操作</b></td>
    <% }else{ %>
    <td  class="TableHeader" nowrap align="center" width=200><b>操作</b></td>
    <%} %>
    </tr>
