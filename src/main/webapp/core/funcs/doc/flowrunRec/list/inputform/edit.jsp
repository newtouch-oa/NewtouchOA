...
var attachUrl = "core/funcs/doc/flowrun/doc/";//附件路径
var swfupload;
var runId = '<%=runId%>';
var flowId = '<%=flowId%>';
var userId = '<%=userId%>';
...
<form style="padding-bottom:80px" action="<%=contextPath %>/yh/core/funcs/doc/act/YHFormEditAct/uploadFile.act" name="workFlowForm" target="returnPage" id="workFlowForm"  method="post" enctype="multipart/form-data">
...
<form style="padding-bottom:10px" action="<%=contextPath %>/yh/core/funcs/doc/act/YHAttachmentAct/uploadFile.act" name="formFile" target="returnPage" id="formFile"  method="post" enctype="multipart/form-data">
