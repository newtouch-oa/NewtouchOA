<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
     <%@ include file="/core/inc/header.jsp" %>
      <%@ page  import="yh.core.funcs.doc.receive.data.YHDocConst,yh.core.util.YHUtility"%>
<%
...
function createNewWork1(flowName , par){
  var url = contextPath + "/yh/core/funcs/doc/act/YHFlowRunAct/createWork.act";
  if (par) {
  ...
  if(json.rtState == "0"){
    ...
    var url2 =  contextPath + "/core/funcs/doc/flowrun/list/inputform/index.jsp?runId=" + runId + "&flowId=" + flowId + "&prcsId=1&flowPrcs=1&isNew=1";
    location.href = url2;
  }else{
    alert(json.rtMsrg);
  }
