...
function Ok(){
  ...
  oActiveEl = CreateNamedElement(oEditor, oActiveEl, 'INPUT', {title: GetE('itemName').value,id:idtr,name:idtr ,src: contextPath + "<%=moduleContextPath %>/flowform/editor/plugins/NCalcu/calc.gif" });
