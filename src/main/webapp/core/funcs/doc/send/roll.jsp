...
<script type="text/javascript" src="<%=contextPath%>/core/funcs/doc/send/js/pickup.js"></script>
<script type="text/javascript">
var runId = "<%=runId%>";
var prcsId = "<%=prcsId %>";
var flowId = "<%=flowId%>";
var flowPrcs = "<%=flowPrcs %>";
var requestUrl = contextPath + "/yh/core/funcs/doc/send/act/YHDocAct";
function doInit(){
  var url = requestUrl + "/hasSend.act";
...
<table class="TableBlock" width="90%"  align="center">
  ...
  <tr><TD class="TableData" >文件主题词：</TD>
...
<div id="notshow" align="center" style="display:none">
<table class="MessageBox" width="300">
    <tbody>
        <tr>
            <td id="outMsgInfo" class="msg info">
            公文还没有发送，请先发送！<br><input type="button" value="关闭" class="BigButton"  name="button" onclick="top.win.closePage();"/>
            </td>
        </tr>
    </tbody>
</table>
