...
function Init(){
  ...
  if(CheckForm()){
    var URL = "<%=contextPath%>/yh/core/funcs/calendar/act/YHTaskAct/updateTaskByUser.act";
...
<form action="<%=contextPath%>/yh/core/funcs/calendar/act/YHTaskAct/updateTask.act"  method="post" id="form1" name="form1" onsubmit="return CheckForm();">
 ...
 <table class="TableBlock" width="450" align="center">
    ...
    <tr>
      ...
      <td class="TableData">
       <a id="colorName" href="javascript:;" class="CalColor" onclick="showMenuColor(event);" hidefocus="true"><span id="colName">未指定</span><span style="font-family:Webdings">6</span></a><input type="hidden" id="color" name="color" value="">
      </td>
      <td nowrap class="TableContent">优先级：</td>
      <td class="TableData">
       <a id="importantName" href="javascript:;" class="CalLevel" onclick="showMenu(event);" hidefocus="true"><span id="impName">未指定</span><span style="font-family:Webdings">6</span></a><input type="hidden" id="important" name="important" value="">
      </td>
    </tr>
    <tr>
