 ...
 */
function exportDept(){
  location = contextPath + "/yh/core/funcs/dept/act/YHDeptAct/exportToExcel.act";
}
/**
 * 导入部门
 * 
...
function importDept(){
  var flag = "1";
  var parent = window.parent.deptinput;
  parent.location = contextPath + "/core/funcs/dept/importDept.jsp?flag="+flag;
}

function importDept2(){
  if($("csvFile").value == ""){ 
    alert("请选择要导入的文件！");
    $("csvFile").focus();
    return false;
