...
function checkForm(){
	...
	if(!$("USER_ID").checked && !$("MANAGE_USER").checked && !$("DEL_USER").checked && !$("NEW_USER").checked && !$("DOWN_USER").checked && !$("OWNER").checked){
		alert("请指定设置选项!");
		return false
	}
	return true;
...
<table class="TableBlock" width="100%" align="center">
  ...
  <tr>
    ...
    <td class="TableData">
      ...
      <input type="checkbox" name="check" id="MANAGE_USER" value="MANAGE_USER" checked><label for="MANAGE_USER">编辑权限</label><br>
