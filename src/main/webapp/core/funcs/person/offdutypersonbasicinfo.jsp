...
<table id="baseInfo" class="TableBlock" width="95%" align="center">
  ...
  <tr>
    ...
    <td nowrap class="TableContent">
      <font style="color:red">*</font>
      <input type="text" id="userName" name="userName" class="BigInput" size="10" maxlength="30" value="">&nbsp;
    </td>
  </tr>
  ...
  <tr id="deptOther" style="display:none;">
    ...
    <td class="TableData">
      ...
      <a href="javascript:;" class="orgAdd" onClick="selectDept(['dept', 'deptDesc'],'','1')">添加</a>
