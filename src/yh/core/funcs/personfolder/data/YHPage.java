package yh.core.funcs.personfolder.data;


public class YHPage {
  
  public static final int DEFAULT_PAGE_SIZE = 24;// 默认每页显示行数
...
/**
 * 调用此文件构造方法
 * @param pageSize 一个页面显示的数目
 * @param count 查找总数据
 * @param pageIndex 页号参数
 */
  public YHPage(int pageSize,long count, int pageIndex) {
  ...
  public void display() {
    ...
    //System.out.println(totalRowNum + "条查询结果，以下是第 " + (firstResult +1)+ "-"
//        + lastResult + " 条。");
  ...
  public static void main(String[] args) {
    YHPage page = new YHPage(20,4567,10);
    page.display();
