...
import yh.core.funcs.doc.logic.YHDocWordLogic;
...
public class YHDocWordAct {
  ...
  public String isHaveDocWordAct(HttpServletRequest request, HttpServletResponse response) throws Exception {
    try {
      ...
      if (flag) {
        ...
        request.setAttribute(YHActionKeys.RET_MSRG, "文件字重复");
      } else {
        request.setAttribute(YHActionKeys.RET_STATE, YHConst.RETURN_ERROR);
        request.setAttribute(YHActionKeys.RET_MSRG, "文件字未重复");
      }
  ...
  public String addDocWordAct(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    return YHWorkFlowConst.MODULE_CONTEXT_PATH + "/flowrun/docword/newRemind.jsp";
  }
  ...
  public String updateDocWordAct(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    return YHWorkFlowConst.MODULE_CONTEXT_PATH + "/flowrun/docword/editRemind.jsp";
  }
