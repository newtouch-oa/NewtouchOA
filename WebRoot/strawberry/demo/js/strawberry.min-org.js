...
UndoRedoEventFactory.prototype = {
    init: function () {
        var a = new com.xjwgraph.UndoRedoEvent(function () {}, PathGlobal.newGraph);
        a.setRedo(function () {})
    },
        ...
        d.onmousedown = function (m) {
            ...
            n.onmouseup = function (C) {
                ...
                if (h.contextMoveAttempt) {
                    ...
                    for (var G = J; G--;) {
                        var O = z[G];
                        line = $id(O), newLineLeft = N - p, newLineTop = L - l, path = f.getPath(line), paths = f.getPathArray(path), pathLength = paths.length, lineMode = A.lineMap.get(line.id), xBaseMode = lineMode.xBaseMode, wBaseMode = lineMode.wBaseMode;
                        F.put(O, path);
...
LineTool.prototype = {
    ...
    formatPath: function (a) {
        if (this.isVML) {
            a = a.replaceAll(",", " "), a = a.replaceAll("e", "z"), a = a.replaceAll("l", "L ")
        } else {
            a = a.replaceAll(",NaN NaN", ""), a = a.replaceAll(",undefined undefined", "")
        }
        return a
    },
    ...
    getPathArray: function (a) {
        a = a.replace("M", ""), a = a.replace("m", ""), a = a.replace("z", ""), a = a.replace("L", ""), a = a.replace("  ", " "), a = a.replaceAll(",", " ");
    ...
    removeNode: function () {
        ...
        h.forEach(function (w) {
            ...
            if (h.isActiveMode(v)) {
                ...
                r[q++] = v;
                a = o.modeMap.get(w).lineMap, baseLineKey = a.getKeys(), baseLineKeyLength = baseLineKey.length;
