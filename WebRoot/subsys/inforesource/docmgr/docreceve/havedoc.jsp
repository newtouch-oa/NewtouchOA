...
<tr class="TableHeader">
  <%
   ...
   <%} %>
  <td nowrap align="center" style="cursor:pointer;" ><u id="TITLE ">标题</u>&nbsp;</td>
  <td nowrap align="center" style="cursor:pointer;"><u id="DOC_NO">文号</u>&nbsp;</td>  
  <td nowrap align="center" style="cursor:pointer;"><u id="COPIES">份数</u>&nbsp;</td>
   <td nowrap align="center" style="cursor:pointer;"><u id="CONF_LEVEL">密级</u>&nbsp;</td>
  <td nowrap align="center" style="cursor:pointer;"><u id="DOC_TYPE">类型</u>&nbsp;</td>
  <td nowrap align="center" style="cursor:pointer;"><u id="FROMUNITS">来电单位</u>&nbsp;</td>
  <td nowrap align="center" style="cursor:pointer;"><u id="SPONSOR">承办部室</u>&nbsp;</td>
  <td nowrap align="center" style="cursor:pointer;"><u id="CREATE_USER_ID">签收人</u>&nbsp;</td>
    ...
    <%} %>
      ...
      <td align="center"><%=docs.get(i).getSponsorName() %>&nbsp;</td>
		  ...
		  <td nowrap align="center">
		     <%
		       if("1".equalsIgnoreCase(flag)){%>
		         <a href="javascript:cancel('<%=docs.get(i).getSeq_id() %>');" >撤销</a>	&nbsp;	
