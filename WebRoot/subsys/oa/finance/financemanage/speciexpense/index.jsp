<%@ page language="java" import="java.util.*,yh.core.funcs.person.data.YHPerson"
...
function cost_charge(seqId){
  ...
  chargeStr = encodeURIComponent(chargeStr);
  createNewWork(encodeURIComponent('结算明细单'),'预算ID='+seqId+'&实际支出明细='+chargeStr );
}
...
function selectBudgetApply(){
  var url = "<%=contextPath%>/yh/subsys/oa/finance/act/YHBudgetApplyAct/queryBudget.act?notAffair=1";
   cfgs = {
    dataAction: url,
    ...
    colums: [
           ...
           {type:"selfdef", name:"expenceMoneyTotal", text:"已领额",align:"center", width: "5%",render:chequeMoney},      
           {type:"selfdef", name:"chequeMoneyTotal", text:"已报额",align:"center", width: "5%",render:expenceMoney},       
