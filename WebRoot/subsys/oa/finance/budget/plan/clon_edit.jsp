...
<%@page import="yh.subsys.oa.finance.data.YHBudgetApply"%><html>
<head>
...
function deleteAttachBackHand(attachName,attachId,attrchIndex){
	var url= "<%=contextPath%>/yh/subsys/oa/finance/act/YHBudgetApplyAct/deleleFile.act?attachId=" + attachId +"&attachName=" + encodeURIComponent(attachName) + "&seqId=" + attrchIndex;
...
if(clon_edit.equals("3")){ 
%>
<form action="<%=contextPath%>/yh/subsys/oa/finance/act/YHBudgetApplyAct/updateBudgetApply.act" method="post" name="form1" enctype="multipart/form-data" onSubmit="return checkForm();">
<% }else{ 
%>
<form action="<%=contextPath%>/yh/subsys/oa/finance/act/YHBudgetApplyAct/addBudgetApply.act?clon=1" method="post" name="form1" enctype="multipart/form-data" onSubmit="return checkForm();">
<% }
...
<table width="90%" align="center" class="TableBlock">
   ...
   <tr>
    ...
    <tr>
      ...
      <td class="TableData" >
	  			<input type="text" name="budgetMoney" id="budgetMoney" value="<%=YHUtility.getFormatedStr(ba.getBudgetMoney(),0)%>" size="20" maxlength="16" />&nbsp;金额可以根据下面的预算详细信息自动生成
    ...
    <tr>
      ...
      <td class="TableData" >
	  			<input type="text" name="budgetInMoney" id="budgetInMoney" value="<%=YHUtility.getFormatedStr(ba.getBudgetInMoney(),0) %>" size="20" maxlength="16"/>&nbsp;<font color="red">*仅供参考，请仔细核对！(允许为空)</font>
      </td>
    </tr>
    <tr>
