...
function doInit(){
  ...
  var url = "<%=contextPath%>/yh/subsys/oa/finance/act/YHChargeExpenseAct/expenseSelect.act";
   cfgs = {
    dataAction: url,
    container: "giftList",
    paramFunc: getParam,
    ...
    colums: [
       ...
       {type:"text", name:"chargeUser", text:"报销申请人", width: "7%",align:"center",sortDef:{type:0, direct:"asc"}},
       {type:"text", name:"projId", text:"团组名称", width: "6%",align:"center",render:toProjId},
       {type:"text", name:"chargeMoney", text:"报销金额", width: "6%",align:"center",render:toMoney},
       {type:"text", name:"chargeDate", text:"报销日期",align:"center", width: "6%",render:toDate,sortDef:{type:0, direct:"asc"}},
       {type:"text", name:"runId", text:"操作",align:"center", width: "10%",render:toRunId},
  ...
  if(total <= 0){
    var table = new Element('table',{ "class":"MessageBox" ,"align":"center","width":"340" }).update("<tr>"
        + "<td class='msg info'><div class='content' style='font-size:12pt'>无符合条件报销完成支票</div></td></tr>"
        );
...
function toRunId(cellData, recordIndex, columIndex){
  ...
  if (runId == null || runId == "" || runId <= 0) {
    var paramStr = "<a href='javascript:chargeDetail(" + seqId +")'>查看详情</a>";
    return paramStr;
  }
  //&nbsp;<a href='javascript:editCharge(" + seqId +")'>编辑</a>&nbsp;<a href='javascript:delCharge(" + seqId +")'>删除记录</a>
}
...
function applyExpense(){
  myleft=(screen.availWidth-800)/2;
  window.open("<%=contextPath%>/subsys/oa/finance/expense/charge/news/newexpense.jsp","","height=600,width=850,toolbar=no,menubar=no,scrollbars=yes,resizable=yes,location=no,left="+myleft+",top=50");
}
function addTr(){
...
<input type="hidden" value="1" name="expense" id="expense">
  ...
  <tr class="TableContent">
    ...
    <INPUT type="text"  name="chargeItem" id="chargeItem" size="10" class="BigInput">
     &nbsp;财务审批人：
      ...
      &nbsp;报销金额：
     <INPUT type="text"  name="chargeMoney" id="chargeMoney" size="10" class="BigInput" size="15" maxlength="15">
     </td>
    </tr>  
  <tr class="TableControl">
    <td rowspan=2 align="center">
      <input value="查询" type="button" class="BigButton" title="查询" onClick="queryGift()">&nbsp;&nbsp;
      <input value="申请报销" type="button" class="BigButtonW" title="申请报销" onClick="applyExpense();">&nbsp;&nbsp;
    </td>
  </tr>   
</table>
</form>
