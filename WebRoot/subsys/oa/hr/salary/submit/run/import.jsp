...
function getSalDataCountByFlowId(){
	var requestURLStr = "<%=contextPath%>/yh/subsys/oa/hr/salary/submit/act/YHHrSubmitAct";
...
function downCSVTemplet(){
	var downUrl = "<%=contextPath%>/yh/subsys/oa/hr/salary/submit/act/YHHrSubmitAct";
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  ...
  <br>
  <form name="form1" id="form1" action="<%=contextPath%>/yh/subsys/oa/hr/salary/submit/act/YHHrSubmitAct/impSubmitInfoByCsv.act" method="post" enctype="multipart/form-data">
<table class="TableBlock" align="center" width="70%">
 ...
 <tr style="display: none;" class="TableData" align="center" height="30">
   <td width="150" align="right"><b>&nbsp;&nbsp;计算项选择：</b></td>
   <td align="left" width="400">
...
<tr>
  <td nowrap  class="TableControl" colspan="2" align="center">
    ...
    <input type="button" value="返回" class="BigButton" onClick="location='<%=contextPath%>/subsys/oa/hr/salary/submit/run/manage.jsp';" title="返回">
  </td>
 </tr> 
</table>
</form>
