...
function opts(cellData, recordIndex, columIndex) {
	...
	return "<center>" + "<a href=javascript:doEdit(" + seqId + ")>录入</a><br>"
...
function doEdit(seqId) {
	location.href = contextPath
			+ "/subsys/oa/hr/salary/submit/run/index1.jsp?flowId=" + seqId;
}
function importFun(seqId) {
	location.href = contextPath
			+ "/subsys/oa/hr/salary/submit/run/import.jsp?seqId=" + seqId;
}
