...
function getSalDataCountByFlowId(){
	var requestURLStr = "<%=contextPath%>/yh/subsys/oa/hr/salary/salFlow/act/YHHrSalFlowAct";
...
function downCSVTemplet(){
	var downUrl = "<%=contextPath%>/yh/subsys/oa/hr/salary/salFlow/act/YHHrSalFlowAct";
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  ...
  <br>
  <form name="form1" id="form1" action="<%=contextPath%>/yh/subsys/oa/hr/salary/salFlow/act/YHHrSalFlowAct/impSalDataInfoToCsv.act" method="post" enctype="multipart/form-data">
