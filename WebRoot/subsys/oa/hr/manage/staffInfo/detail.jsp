...
function doInit(){
	...
	var url = requestURLStr + "/getDetailHrStaffInfo.act";
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=imgPath %>/hr_manage.gif" width="17" height="17"><span class="big3"> 人事档案详细信息</span><br></td>
  </tr>
</table>
...
<tr>
  ...
  <tr>     
    <td nowrap align="left" width="120" class="TableContent">社保号：</td>
    <td class="TableData"  width="180" colspan="5"><span id="insureNum"></span> </td> 
  </tr>
  <tr>
  ...
  <tr>
    <td class="TableData" colspan="3">
    	<textarea cols="45" name="certificate" id="certificate" rows="3" class="BigInput" wrap="on"></textarea>
    </td>
    <td class="TableData" colspan="3">
    	<textarea cols="45" name="surety" id="surety"   rows="3" class="BigInput" wrap="on" ></textarea>
    </td>
  </tr>
  <tr>
