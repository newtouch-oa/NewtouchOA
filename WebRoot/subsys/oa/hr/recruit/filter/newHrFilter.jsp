...
function doSubmit(){
	if(checkForm()){
		...
		var url = "<%=contextPath%>/yh/subsys/oa/hr/recruit/filter/act/YHHrRecruitFilterAct/addHrFilterInfo.act";
...
<table border="0" width="90%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td><img src="<%=imgPath %>/notify_new.gif" align="middle"><span class="big3"> 新建招聘筛选信息</span>&nbsp;&nbsp;
    </td>
  </tr>
</table>
<br>
...
<table class="TableBlock" width="100%" align="center">
  ...
  <tr>
    ...
    <td class="TableData" >
      <INPUT type="text" name="transactorStepName" size="15" class="BigStatic" readonly value="<%=person.getUserName() %>">&nbsp;
      <INPUT type="hidden" name="transactorStep" value="<%=person.getSeqId() %>">
    </td>     
  </tr>
  <tr>
