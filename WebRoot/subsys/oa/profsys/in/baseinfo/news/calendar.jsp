...
function set_work(){
  ...
  if(status=='0'){
    var URL = "<%=contextPath%>/subsys/oa/profsys/in/baseinfo/news/calendar/calendarNote.jsp?seqId="+seqId;
...
function set_year(index){
  ...
  window.location="<%=contextPath%>/subsys/oa/profsys/in/baseinfo/news/calendar.jsp?year="+year+"&month="+month;
}
...
function today(){
  window.location.href = "<%=contextPath%>/subsys/oa/profsys/in/baseinfo/news/calendar.jsp";
}
function doOnload(){
...
function newCalendar(year,month,day){
  ...
  projId = $("projId").value;
  var URL = "<%=contextPath%>/subsys/oa/profsys/in/baseinfo/news/calendar/newCalendar.jsp?&year="+year+"&month="+month+"&day="+day+"&projId="+projId;
