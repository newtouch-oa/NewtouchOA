...
function doInit(){
  ...
  var param = "projNum=<%=projNum%>&projActiveType=<%=projActiveType%>&projStartTime=<%=projStartTime%>"
    ...
    + "&projEndTime=<%=projEndTime%>&projEndTime1=<%=projEndTime1%>&projLeader=<%=projLeader%>";
  var url = "<%=contextPath%>/yh/subsys/oa/profsys/act/out/YHProjectAct/profsysSelect2.act?" + param;
   cfgs = {
    dataAction: url,
    container: "giftList",
    afterShow:getTotal2,
