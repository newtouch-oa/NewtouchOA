...
<input type="hidden" name="projCommType" id="projCommType" value="2">
...
<table class="TableBlock" border="0" width="80%" align="center">
    ...
    <td nowrap class="TableContent">纪要名称：</td>
      <td nowrap class="TableData">
        <input type="text" class="BigInput" name="commName" id="commName" value="" size="10" maxLength="40">
      </td> 
    </tr>
    <tr>
    ...
    <td nowrap class="TableContent">外方人员：<span style="color:red">*</span></td>
      ...
      <td nowrap class="TableData">
        <input type="text" class="BigInput" name="commPlace" id="commPlace" value="" size=30 maxLength="40">
      </td> 
     </tr>
     <tr>
