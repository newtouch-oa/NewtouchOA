...
function checkForm() {
  ...
  var url = "<%=contextPath %>/subsys/oa/profsys/active/queryNoFinance/list.jsp?" + param;
  window.location = url;
}
//项目成员
function checkForm2() {
  var pars = $('form1').serialize();
  var param = encodeURI(pars);
  var url = "<%=contextPath%>/subsys/oa/profsys/active/queryNoFinance/listMem.jsp?" + param;
  window.location = url;
}
//项目日程
function checkForm3() {
  var pars = $('form1').serialize();
  var param = encodeURI(pars);
  var url = "<%=contextPath%>/subsys/oa/profsys/active/queryNoFinance/listCalendar.jsp?" + param;
  window.location = url;
}
//会议纪要
function checkForm4() {
  var pars = $('form1').serialize();
  var param = encodeURI(pars);
  var url = "<%=contextPath%>/subsys/oa/profsys/active/queryNoFinance/listComm.jsp?" + param;
  window.location = url;
}
//文档
function checkForm5() {
  var pars = $('form1').serialize();
  var param = encodeURI(pars);
  var url = "<%=contextPath%>/subsys/oa/profsys/active/queryNoFinance/listFile.jsp?" + param;
  window.location = url;
}
//团组名称
...
<input type="hidden" value="2" name="projType" id="projType">
<input type="hidden" value="2" name="projMemType" id="projMemType">
<input type="hidden" value="2" name="projCalendarType" id="projCalendarType">
<input type="hidden" value="2" name="projCommType" id="projCommType">
<input type="hidden" value="2" name="projFileType" id="projFileType">
...
<fieldset style="padding-bottom:5px;padding-left: 10xp;padding-right: 10px">
   <legend class="small" align=left>
     ...
     <table cellspacing="1" class="small" align="left" cellpadding="3" width="100%">
       <tr>
         <td nowrap class="TableData">活动编号：</td>
...
<table cellspacing="1" class="small" align="left" cellpadding="3" width="100%">
  ...
  <tr>
   ...
   <tr>
    <td nowrap class="TableData">单位编号： </td>
      <td nowrap class="TableData"> 
        <INPUT type="text" name="unitNum" id="unitNum" class=BigInput size="10">
      </td> 
    <td nowrap class="TableData" width="90">单位名称：</td>
      <td nowrap class="TableData">
        <input type="text" class="BigInput" name="unitName"  id="unitName" size="18"><span id="check_msg"></span>
      </td>
    </tr>
   <tr>
    <td nowrap class="TableData"  colspan="6" align="right">
