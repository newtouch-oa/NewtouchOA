...
function getVoteById(seqId){
  ...
  if(prc.seqId){
    ...
    buttonStr = buttonStr + " <input type='button' value='导出' class='BigButton' onClick='javascript:outVote();'>&nbsp;&nbsp";
...
//显示投票人员信息
function selectReadersInfo(seqId){
  var url= "<%=contextPath%>/yh/subsys/oa/vote/act/YHVoteDataAct/selectReadersInfo.act?seqId="+seqId;
  var rtJson = getJsonRs(url); 
  if(rtJson.rtState == "1"){
	alert(rtJson.rtMsrg); 
	return ; 
  ...
  var prc = rtJson.rtData;
  var count = parseInt(prc.personCount,10) - parseInt(prc.readerCount,10);
  $("count").innerHTML = "  (已投票："+prc.readerCount+"人，未投票："+count+"人)";
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" align="center" class="small">
  <tr>
    <td><img src="<%=imgPath %>/vote.gif" align="absmiddle"><span class="big3"> 投票结果 -</span><span id="subject"></span><span id="count"></span> <br>
    </td>
    </tr>
  <tr>
