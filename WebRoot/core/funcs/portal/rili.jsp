...
<HTML><HEAD><TITLE>万年历中华</TITLE>
<META content="农历; 万年历; 月历; 节日; 时区; 节气; 八字; 干支; 生肖; gregorian solar; chinese lunar; calendar;" 
name=keywords>
...
document.fgColor = "000000";
      ...
      style="FONT-SIZE: 9pt" onchange=changeTZ() name=TZ> <OPTION 
        ...
        value="+0800 北京、重庆、黑龙江" selected>中国<OPTION 
        value="+0800 台湾、香港、新加坡">台北<OPTION 
