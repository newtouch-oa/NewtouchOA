...
function Ok(){  //把表单插入到fck的工作区当中
  ...
  oActiveEl = CreateNamedElement( oEditor, oActiveEl, 'TEXTAREA', {title: GetE('txtName').value,id:idtr ,name:idtr ,src:contextPath + "/core/funcs/workflow/flowform/editor/plugins/NTextArea/textarea.gif"} ) ;
