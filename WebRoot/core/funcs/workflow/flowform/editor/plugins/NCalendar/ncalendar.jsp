...
function Ok(){
  ...
  oActiveEl = CreateNamedElement(oEditor, oActiveEl, 'IMG', {title: '日期控件:' + GetE('itemName').value,id:idtr ,name:idtr ,src:"<%=contextPath%>/core/funcs/workflow/flowform/editor/plugins/NCalendar/calendar.gif"});
//日期类型
