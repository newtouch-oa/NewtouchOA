...
function getData(val){
  if(val != ''){
    ...
    if (allList[val]) {
      ...
      var url = contextPath + "/yh/core/funcs/workflow/act/YHFormDataSelect/getData.act";
...
function getDataSrc(val){
  var url = contextPath + "/yh/core/funcs/workflow/act/YHFormDataSelect/getDataConfig.act";
