...
var isPrint = false;
function doInit() {
  var url = contextPath + "/yh/core/funcs/workflow/act/YHFlowFormViewAct/getFormView.act";
...
<form enctype="multipart/form-data" name="workFlowForm" id=workFlowForm>
