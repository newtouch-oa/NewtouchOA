...
<%@page import="java.text.SimpleDateFormat" %>
	<%
	 String rId=request.getParameter("rId");
      ...
      if (YHUtility.isNullorEmpty(versionNo)) {
        versionNo = "1";
      }
...
function getJson(){
	 var url = contextPath + "/yh/core/funcs/workflow/act/YHFlowReportAct/getReportByRidAct.act?rId=<%=rId%>";
...
function export_excel()
{
 ...
 function export_excel(){
     $("form1").action=contextPath+"/yh/core/funcs/workflow/act/YHFlowReportAct/toExcel.act";
     $("form1").target="";
     $("form1").submit();
...
<table width="70%" class="TableList" id="table" align="center">
  ...
  <input type="hidden" value="<%=versionNo %>" name="versionNo" id="versionNo"/>
