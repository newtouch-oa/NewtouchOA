...
function InitList(){
	  var url = contextPath + "/yh/core/funcs/workflow/act/YHFlowReportAct/editReportAct.act";
...
<form action="<%=contextPath %>/yh/core/funcs/workflow/act/YHFlowReportAct/updateReportAct.act?rId=<%=rId %>&fId=<%=fId %>" enctype="multipart/form-data" method="post" id="form1" name="form1">
