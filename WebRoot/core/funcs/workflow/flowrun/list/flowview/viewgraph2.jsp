<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <%@ page import="java.util.Map,java.util.List,yh.core.util.YHUtility" %>
<%
...
for (Map p : prcsList) {
  ...
  for (Map p2 : list) {
    ...
    for (Map m : userList) {
      ...
      if ("1".equals(state2)) {
        ...
        if(!"".equals(timeOutFlag)){
          String timeOut = YHUtility.null2Empty((String)m.get("timeOut"));
          if (!"".equals(timeOut)) {
            timeOut = "限时" + timeOut +"小时,";
            title += "<br><span style='color:red'>" + timeOut + timeUsed + "</span>";
          }
        }
    ...
    String sRoundrect = "<v:roundrect inset='2pt,2pt,2pt,2pt' id='"
      ...
      + leftVml + "; TOP:"
      + topVml +"; WIDTH: 100; POSITION: absolute; HEIGHT: 50;vertical-align:middle;cursor:pointer;TEXT-ALIGN:center;z-index:1' arcsize='4321f' coordsize='21600,21600' title=''>";
