var requestUrl = contextPath + "/yh/core/funcs/workflow/act/YHFreeFlowTypeAct";
...
function addUser(i){
  ...
  var chooseType = window.showModalDialog(contextPath + "/core/funcs/workflow/flowrun/list/turn/userSelect/FreeFlowUserSelect.jsp",window,"dialogLeft=500px;dialogTop=350px;dialogWidth=510px;dialogHeight=400px;status=no;resizable=no"); 
}
function showItem() {
...
function TurnNext_forwardPage() {
  if (isManage) {
    location = contextPath + "/core/funcs/workflow/flowrun/manage/index.jsp?skin="+skin+"&sortId=" + sortId;
  } else {
