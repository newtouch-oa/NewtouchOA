...
function Init(){
  if( CheckForm()){
    var requestURL= "<%=contextPath%>/yh/core/funcs/attendance/personal/act/YHAttendOutAct/updateStatus.act";
  ...
  <table class="TableBlock" width="90%" align="center">
    ...
    <tr>
      ...
      <td class="TableData">
         ...
         由 <input type="text" id = "outTime1" name="outTime1" size="5" maxlength="5" class="BigInput" value="" readonly>
