...
<br>
<form action="<%=contextPath%>/yh/core/funcs/attendance/personal/act/YHAttendLeaveAct/updateLeave.act"  method="post" id="form1" name="form1" class="big1" onsubmit="return CheckForm();">
<input type="hidden" id="dtoClass" name="dtoClass" value="yh.core.funcs.attendance.personal.data.YHAttendLeave"/>
...
<td nowrap class="TableData">请假天数：</td>
  <td class="TableData"><input type="text" name="leaveDays" id="leaveDays" size="3" maxlength="3" value="0" class="BigInput">天，年休假剩余<font color="red" id="annualOverplus">0</font>天
  </td>
 </tr>    
    <tr style="display:none">
      <td nowrap class="TableData"> 使用年休假(<font color="red">整数</font>)：</td>
      <td class="TableData">
      	 <input type="text" id="annualLeave" name="annualLeave" size="3" maxlength="3" class="BigInput" value="0">
      </td>
    </tr>
    <tr>
    ...
    <tr align="center" class="TableControl">
      ...
      <input type="hidden" id="annual" name="annual" value="0" >&nbsp;&nbsp;
        ...
        <input type="button" value="返回" class="BigButton" onclick="location='leave.jsp'">&nbsp;&nbsp;
      </td>
    </tr>
  </table>
</form>
