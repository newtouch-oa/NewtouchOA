var requestUrl = contextPath + "/yh/core/funcs/doc/act/YHFreeFlowTypeAct";
...
function addUser(i){
  ...
  var chooseType = window.showModalDialog(contextPath + "/core/funcs/doc/flowrunRec/list/turn/userSelect/FreeFlowUserSelect.jsp",window,"dialogLeft=500px;dialogTop=350px;dialogWidth=510px;dialogHeight=400px;status=no;resizable=no"); 
}
function showItem() {
...
function turnNext () {
  ...
  var url = contextPath + "/yh/core/funcs/doc/flowrunRec/act/YHMyWorkAct/turnNext.act";
