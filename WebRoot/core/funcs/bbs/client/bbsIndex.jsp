...
<%@ page language="java" import="oa.core.funcs.bbs.act.BbsService,oa.core.funcs.bbs.act.BBSUtil,java.lang.reflect.Field,oa.core.funcs.bbs.act.BbsBoard,java.sql.ResultSet" %>
<%
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tbody><tr>
    <td class="Big"><img src="/yh/core/funcs/system/netdisk/images/notify_open.gif" align="middle"><span class="big3">讨论区</span>
    </td>
  </tr>
</tbody></table>
<br>
...
<tr class="TableHeader" align="center" style="font-size:10pt">
      ...
      <td nowrap align="center" width="20%">帖数</td>
      <td nowrap align="center">最后发表</td>
      <td nowrap align="center" width="30%">版主</td>
</tr>
...
List bdlist=new BbsService().getUserBBSBoard(o,request);
 for(int i=0;i<bdlist.size();i++){
 BbsBoard bbsB=(BbsBoard)bdlist.get(i);
 %>
 
<tr width="90%" class="TableLine1" font-size="10pt">
<td align="center"><a href="bbsBoardComment.jsp?boardId=<%=bbsB.getBoarderId()%>&&boardName=<%=bbsB.getBoardName()%>"><b><%=bbsB.getBoardName()%></b></a><br><%=bbsB.getWelcome()%></td>
      <td align="center"><%if(bbsB.getAnonymity().equals("1")){ %>
      允许
      <%}else{ %>
      禁止
      <%} %></td>
