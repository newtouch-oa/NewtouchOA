...
<%
  ...
  phone1 = YHUtility.encodeSpecial(phone1);
  if (phone1 == null){
    phone1 = "";
  }
...
function doInit(){
  ...
  var checkPer = "";
  var moduleCode = 2;
  var url = "<%=contextPath%>/yh/core/funcs/system/censorcheck/act/YHCensorCheckAct/getMobilSmsSearchJson.act?censorFlag="+censorFlaga+"&content="+encodeURIComponent(content)+"&phone1="+phone1;
...
<input type="button" value="返回" class="BigButton" onclick="location='<%=contextPath%>/core/funcs/system/censorcheck/mobilesms/index.jsp'">
</center>
</body>
</html>