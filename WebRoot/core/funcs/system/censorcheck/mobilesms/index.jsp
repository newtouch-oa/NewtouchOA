...
function doInit(){
  ...
  var url = "<%=contextPath%>/yh/core/funcs/system/censorcheck/act/YHCensorCheckAct/getCensorContentMobilSmsJson.act";
   ...
   // var url = "<%=contextPath%>/yh/core/funcs/system/censorcheck/act/YHCensorCheckAct/getCensorChangeName.act?formId="+userSum;
	...
	//}
      ...
      var seqId = rtJson.rtData[i].seqId;
  	  var phone = rtJson.rtData[i].cont.PHONE;
      var phone1 = rtJson.rtData[i].cont.PHONE1 || "";
  	  ...
  	  var tr=new Element('tr',{'class':'TableLine1'});			
			...
			tr.update("<td align='center'>"					
			  + "<input type='checkbox'id='deleteFlag' name='deleteFlag' value="+seqId+"></td><td align='center'>"
				...
				+ phone1 + "</td><td align='left'>"						
				+ highLight(contents) + "</td><td>"					
				+ sendTime + "</td>"					
			);
			toIdName = "";
  	}
...
function checkDeny(){
  ...
  var rtJson = getJsonRs(url, "sumStrs=" + idStrsVal);
    if (rtJson.rtState == "0") {
...
function searchCensor(){
  ...
  location = "<%=contextPath%>/core/funcs/system/censorcheck/mobilesms/search.jsp?censorFlag="+censorFlag+"&checkBegin="+checkBegin+"&checkEnd="+checkEnd+"&fromId="+fromId+"&phone1="+phone1+"&content="+content+"&toId="+toId+"&beginDate="+beginDate+"&endDate="+endDate+"&limit="+limit;
}
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=imgPath%>/infofind.gif" align="absmiddle"><span class="big3">&nbsp;手机短信审核查询</span>
    </td>
  </tr>
</table>
...
<table class="TableBlock" width="600" align="center">
  <form name="form1">
    ...
    <tr>
      <td nowrap class="TableData">外部收信人号码：</td>
      <td class="TableData"><input type="text" size=36 name="phone1" id="phone1" class="BigInput">
      </td>
    </tr>
    <tr>
