...
function doInit(){
  ...
  var url = "<%=contextPath%>/yh/core/funcs/system/censorcheck/act/YHCensorCheckAct/getCensorContentJson2.act?censorFlag="+censorFlaga+"&content="+encodeURIComponent(content)+"&subject="+encodeURIComponent(sub);
  	  ...
  	  var tr=new Element('tr',{'class':'TableLine1'});			
			...
			tr.update("<td align='center'>"					
			  + "<input type='checkbox'id='deleteFlag' name='deleteFlag' value="+seqId+"></td><td align='center'>"
				...
				+ "<a href='readmail.jsp?seqId="+seqId +"&formIdName="+formIdName +"&toIdName="+toIdName +"&sendTime="+sendTime +"&subject="+subject +"&contents="+contents +"&bodyId="+bodyId +"'> "+subject+"</a></td><td>"					
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=imgPath%>/infofind.gif" align="absmiddle"><span class="big3">&nbsp;审核邮件查询（最多显示100条记录）</span>
    </td>
  </tr>
</table>
...
<input type="button" value="返回" class="BigButton" onclick="location='<%=contextPath%>/core/funcs/system/censorcheck/email/index.jsp'">
</center>
</body>
</html>