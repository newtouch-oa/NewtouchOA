...
var DeptId,DeptName;
var deptList = [];
var reciveDept = '<%=reciveDept %>';

function doInit(){
  var url = contextPath + "/yh/core/esb/client/act/YHDeptTreeAct/getTreePermissions3.act?reciveDept="+reciveDept+"&id=";
...
function getDefaultDept() {
  url = contextPath + "/yh/core/esb/client/act/YHDeptTreeAct/getDeptsByDeptParent2.act?deptId=0";
...
function treeNodeClick(id){
  url = contextPath + "/yh/core/esb/client/act/YHDeptTreeAct/getDeptsByDeptParent2.act";
...
function addDiv(depts){
  ...
  if(depts.length > 0){
    for(var i = 0 ; i < depts.length ; i++){
      ...
      for(var j = 0; j < reciveDeptArray.length; j++){
        if(dept.deptId == reciveDeptArray[j]){
...
<div id="left" style="width: 360px;height: 440px;">
...
<div id="right" class="list" style="width: 340px;padding-right: 20px;">
