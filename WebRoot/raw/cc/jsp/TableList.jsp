...
<html>
	...
	<body>
		<script type="text/javascript" src="<%=contextPath %>/rad/dsdef/js/table.js">
			
	</script>
		<form action="<%=contextPath %>/yh/rad/dsdef/logic/YHDsDefAct" name="dataList" onSubmit='return check()'>
			...
			<div id="table_div" style="display: none; position: absolute;"
				name="tableN_div">
				...
				<table border=1 id="tableDiv" bgcolor=ddddd>
					<thead>
						...
						<tr>
							...
							<td>
								<input type=text id="fkFilter" name="fkFilter" value="">
							</td>
						</tr>
						<tr>
							<td>
