...
var actionUrl = contextPath + "/raw/lh/wizardtool/act/YHWizardToolAct";
var pageMenuData = [
...
function doInit(){
  ...
  var path = "D:\\workspace";
  var config = {bindToContainerId:'left'
    				,requestUrl:actionUrl + '/getFolder.act?path=' + path
					,isOnceLoad:true
...
<script type="text/javascript">
widgetData = {} ;
var sBasePath = contextPath+'/raw/lh/wizardtool/fckeditor/';
