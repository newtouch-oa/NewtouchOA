...
function doInit(){
  var url = "<%=contextPath%>/yh/cms/station/act/YHStationAct/getTemplate.act?stationId=0";
...
function doSubmit(){
  if(checkForm()){
    var url = "<%=contextPath%>/yh/cms/station/act/YHStationAct/addStation.act";
...
function checkPath(){
  ...
  var url = "<%=contextPath%>/yh/cms/station/act/YHStationAct/checkPath.act?stationPath="+$('stationPath').value;
  var rtJson = getJsonRs(url);
	if(rtJson.rtState == "0"){
	  var prcs = rtJson.rtData;
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td><img src="<%=imgPath %>/notify_new.gif" align="middle"><span class="big3"> 新建站点</span>&nbsp;&nbsp;
    </td>
  </tr>
</table>
<br>
