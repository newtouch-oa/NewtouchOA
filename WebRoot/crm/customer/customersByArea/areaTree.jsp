...
<script type="text/javascript" src="<%=contextPath %>/springViews/js/dtree2.js"></script>
...
var tree = null;
function doInit(){
  var flag = getMyManageArea(seqId);  //大的管辖区域
...
{
	var	url = contextPath + '/yh/core/funcs/person/act/YHUserPrivAct/getAllAreas.act';
    d = new dTree('d');
...
<table border="0" width="90%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td><img src="<%=imgPath%>/notify_new.gif" align="absmiddle"><span class="big3">&nbsp;区域范围</span>&nbsp;&nbsp;
    </td>
  </tr>
</table>
<br>
<input type="hidden" value="100" id="testNode">
 <div id="dtreeId" class="dtree" style="overflow-x:auto;overflow-y:auto;overflow: auto;"></div>
