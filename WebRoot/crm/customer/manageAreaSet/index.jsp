...
function doInit() {
  var tabArray = [{title:"人员管辖区域设置", content:"", contentUrl:"<%=contextPath%>/crm/customer/manageAreaSet/manage.jsp?treeId=" + treeId + "&deptParent=" + deptParent + "&deptLocal=" + deptLocal, imgUrl: imgPath + "/cmp/tab/sys_config.gif", useIframe:true}];
