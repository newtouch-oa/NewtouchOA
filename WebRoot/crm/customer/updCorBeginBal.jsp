  ...
  <body>
  	<div class="inputDiv">
        <form id="create" action="customAction.do" method="post">
            <input type="hidden" name="op" value="saveBeginBal" />
            <input type="hidden" id="casId" name="cusId" value="${cusId}" />
            <table class="dashTab inputForm single" cellpadding="0" cellspacing="0">                       
                <tr class="noBorderBot">
                    <th>发货期初余额：</th>
                    <td>
                        <input type="text" id="beginBal" name="beginBal" class="inputSizeL" onBlur="checkPrice(this)"/>
                    </td>
                </tr>
                <tr class="submitTr">
                    <td colspan="2">
