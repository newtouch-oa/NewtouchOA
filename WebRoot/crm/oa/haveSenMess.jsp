  ...
  <head>
    ...
    <script type="text/javascript">
    	function dataMapper(obj){
			...
			dataId = obj.meCode;
			var dblFunc="descPop('messageAction.do?op=showMessInfo&meCode="+obj.meCode+"&mark=haveSend')";
			var title = "<a href='javascript:void(0)' onclick=\""+dblFunc+"\" >"+obj.meTitle+"</a>";
			var user = obj.meRecName;
			var recUser=user.slice(user.indexOf("|")+1);
			var funcCol = "<img src='crm/images/content/del.gif' alt='删除' style='cursor:pointer' onClick=\"oaDelDiv(7,"+obj.meCode+")\"/>";
			datas = [title, recUser, obj.meDate, funcCol ];
			return [datas,className,dblFunc,dataId];
		}
		function loadList(sortCol,isDe,pageSize,curP){
			var url = "messageAction.do";
			var pars = [];
			pars.op = "getHaveSenMess";
			
			var loadFunc = "loadList";
			var cols=[
				{name:"消息主题",align:"left"},
				{name:"接收人",isSort:false,align:"left"},
    	...
    	var gridEl = new MGrid("senMessTab","dataList");
                ...
                <tr>
                    <th>
                        <div id="tabType">
                            ...
                            <div id="tabType2" class="tabTypeWhite" onClick="self.location.href='messageAction.do?op=toListHaveSenMess'" >已发消息</div>
