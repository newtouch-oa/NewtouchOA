...
<head>
    ...
    <script type="text/javascript">
        function dataMapper(obj){
			...
			var customer = "<span class='mLink'><a href='javascript:void(0)' onclick=\""+relFunc+"\"><img src='images/content/showDesc.gif' alt='查看客户详情' class='imgAlign' style='border:0;'>"+obj.cusCorCus.corName+"</a></span>"; 
			var funcCol = "<img onClick=\"recAddDiv(7,'rec','"+obj.serCode+"')\" style='cursor:pointer' src='images/content/restore.gif' alt='恢复'/>&nbsp;&nbsp;<img onClick=\"recAddDiv(7,'del','"+obj.serCode+"')\" style='cursor:pointer' src='images/content/del.gif' alt='彻底删除'/>";
			
			datas = [title, customer, obj.serMethod, obj.serContent, obj.salEmp?obj.salEmp.seName:"", obj.serExeDate, funcCol ];
    	...
    	var gridEl = new MGrid("recServListTab","dataList");
				...
				<table class="normal" cellpadding="0" cellspacing="0" style="width:100%;">
                    <tr>
                        ...
                        <td style="vertical-align:top">
						    <div id="recTil"><span>客户服务</span></div>
						    <div class="bottomBar">
                                	批量操作：&nbsp;&nbsp;<span class="grayBack" onMouseOver="this.className='orangeBox red'" onMouseOut="this.className='grayBack'" onClick="checkBatchDel(17,'客户服务')">批量删除</span>
                       		</div>
