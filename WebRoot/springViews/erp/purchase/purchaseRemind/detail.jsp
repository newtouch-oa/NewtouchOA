...
<%
	String purchaseId = request.getParameter("purchaseId")==null?"":request.getParameter("purchaseId");
	String isCloseFlag = request.getParameter("isCloseFlag")==null?"":request.getParameter("isCloseFlag");
...
function returnPage(){
	window.location.href = contextPath + "/springViews/erp/purchase/purchaseRemind/purchaseRemindAll.jsp";
}	 
function closePage(){
	window.close();
}	 
...
<br>
    ...
    <tr align="center" class="TableControl">
      <td colspan=6 nowrap>
     <%if(!"".equals(isCloseFlag) && isCloseFlag.equals("0")){ %>
       <input type="button" value="关闭" class="BigButton" onclick="closePage()">
     <%}else{ %>
