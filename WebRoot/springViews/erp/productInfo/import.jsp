...
function downCSVTemplet(){
	var downUrl = "<%=contextPath%>/yh/subsys/oa/asset/act/YHProductImportAct";
 ...
 <body class="bodycolor" topmargin="5">
  <table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
    <tr>
      <td class="Big"><img src="<%=imgPath%>/notify_new.gif"><span class="big3"> 导入产品信息</span><br>
      </td>
    </tr>
  </table>
  <br>
  ...
  <div align="center" class="Big1">
    <form name="form1" id="form1" action="<%=contextPath%>/yh/subsys/oa/asset/act/YHProductImportAct/importProduct.act" method="post" enctype="multipart/form-data">
<table class="TableBlock" align="center" width="70%">  
 <tr class="TableData" align="center" height="30">
   ...
   <td width="400" align="left">
    <a href="#" onclick="downCSVTemplet();">产品信息模板下载 </a>
   </td>
 </tr>
 <tr class="TableData" align="center" height="30">
 ...
 <tr class="TableData" align="center" height="30">
  ...
  <td width="400" align="left">
    <span>
    1、使用产品报表模板导入数据，先填内容再导入。

    <br>
    2、将改好的EXECL产品报表另存为CSV格式的文件
...
<tr>
  <td nowrap  class="TableControl" colspan="2" align="center">
    ...
    <input type="button" value="返回" class="BigButton" onClick="window.history.go(-1)" title="返回">
  </td>
 </tr> 
</table>
</form>
