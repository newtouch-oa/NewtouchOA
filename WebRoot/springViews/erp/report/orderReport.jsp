...
function doSubmit(){
	if(checkForm()){
	var saleType=jQuery('#saleType').val();
  
  var beginTime=jQuery('#beginTime').val();
  var endTime=jQuery('#endTime').val();
  var url = contextPath + "/yh/subsys/oa/hr/salary/welfare_manager/act/YHSalaryAnalysisAct/doSaleReport.act";
  var param = "saleType=" + saleType + "&beginTime="+beginTime+"&endTime="+endTime;
    ...
    if ($('MAP_TYPE1').checked) {
      ...
      for (var i = 0 ;i< tableData.length ;i++) {
        table += getRow(tableData[i] , data.dataCount , i)
      	...
      	table+="<tr><td>销售额总计</td><td>"+sum+"</td></tr>"
...
function imageReader(data) {
  ...
  var chartData = {"chart":{ "caption" : "销售额分析" ,  "xAxisName" : "销售员",   "yAxisName" : "销售额总计" }, "data" : []};
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
 <tr>
   <td class="Big"><img src="<%=imgPath%>/finance1.gif" align="absMiddle"><span class="big3">&nbsp;销售额统计分析 </span>
   </td>
 </tr>
</table>
<br>
<table align="center" width="50%" class="TableBlock">
    <tr>
      ...
      <td class="TableData" nowrap   colspan="3">
      	<select id="saleType">
      		...
      		<option value="custorm">客户</option>
      	</select>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td nowrap class="TableContent" width="80" >销售额统计图 ：</td>
      <td class="TableData" nowrap colspan="3">
