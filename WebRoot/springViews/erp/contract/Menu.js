...
Menu.prototype = {
  initialize: function(parameters , divStyle) {
    ...
    this.divStyle = divStyle ? divStyle : {border:'1px solid #69F',width:'70px',position :'absolute',backgroundColor:'#FFFFFF',padding:'5px',display:"block"};
  },
  show:function(event){
  ...
  createMenuDiv:function(event){
   ...
   // alert(locate.y +":"+ locate.x +":"+document.documentElement.scrollHeight)
   ...
   // this.divHeight = this.div.clientHeight == 0 ? 130  :  this.div.clientHeight;
    //if(locate.y>(document.documentElement.scrollHeight-this.divHeight)){
     // temp = document.documentElement.scrollHeight- this.divHeight;
   // }
   // document.body.removeChild(this.div);
    document.body.appendChild(this.div);
    var temp  = this.div.clientHeight + 15;
    document.body.removeChild(this.div);
    var tempNew = temp == 0 ? 130  :  temp;
    if(locate.y>(document.documentElement.scrollHeight-tempNew)){
      tempNew = document.documentElement.scrollHeight- tempNew;
      locate.y = tempNew;
    }
