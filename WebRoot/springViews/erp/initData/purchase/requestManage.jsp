...
function opts(cellData, recordIndex, columIndex){
	...
	if(orderStatus==0){
	return "<center><a href=\"javascript:void(0)\" onclick=\"openAccount('" + reqId + "');\" >开账</a>&nbsp<a href=\"javascript:void(0)\" onclick=\"detail('" + reqId + "');\" >查看</a>&nbsp<a href=\"javascript:void(0)\" onclick=\"edit('" + reqId + "');\" >编辑</a>&nbsp<a href=\"javascript:void(0)\" onclick=\"deletes('" +reqId + "');\" >删除</a></center>";
...
function openAccount(reqId){
 var url = "<%=contextPath %>/SpringR/purchase/openAccount?reqId="+reqId;
	jQuery.ajax({
	   type : 'POST',
	   url : url,
...
function newCreate(){
	window.location.href='requestAdd.jsp?flag=1';
}
</script>
</head>
