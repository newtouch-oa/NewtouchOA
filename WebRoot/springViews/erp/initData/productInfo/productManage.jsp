...
var pageMgr = null;
function doInit(){
     var url = "<%=contextPath %>/SpringR/product/productList?shortName=-1";
	  var cfgs = {
	      dataAction: url,
...
function edit(id){
	window.location.href='proAdd.jsp?id='+id;
}
function deletes(id){
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
 <tr>
   <td class="Big"><img src="<%=imgPath%>/infofind.gif" align="absMiddle"><span class="big3">&nbsp;产品信息管理</span>
   </td>
   <td class="Big">
   <input type="button" value="添加" class="BigButton" onclick="javascript:window.location.href='proAdd.jsp'">
   </td>
 </tr>
</table>
<br>
