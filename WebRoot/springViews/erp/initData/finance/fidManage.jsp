...
function selectOPTByStatus(fi_id,fid_id,code,status){
	if(status==0){
		return "<center><a href=\"javascript:void(0)\" onclick=\"openAccount('" + fid_id + "');\" >开账</a>" +
...
function openAccount(fid_id){
 var url = "<%=contextPath %>/SpringR/finance/openAccountFID?fid_id="+fid_id;
	jQuery.ajax({
	   type : 'POST',
	   url : url,
	   success : function(jsonData){   
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
 <tr>
   <td class="Big"><img src="<%=imgPath%>/infofind.gif" align="absMiddle"><span class="big3">&nbsp;应收明细管理</span>
   </td>
 </tr>
</table>
<br>
