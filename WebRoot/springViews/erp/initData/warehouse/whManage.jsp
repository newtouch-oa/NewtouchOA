...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
 <tr>
   <td class="Big"><img src="<%=imgPath%>/infofind.gif" align="absMiddle"><span class="big3">&nbsp;仓库管理</span>
   </td>
   <td class="Big">
   <input type="button" value="新建仓库" class="BigButton" onclick="javascript:window.location.href='addwh.jsp'">
   </td>
 </tr>
</table>
<br>
