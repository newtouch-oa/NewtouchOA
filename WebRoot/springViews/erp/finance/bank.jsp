...
function opts(cellData, recordIndex, columIndex){
	...
	return "<center><a href=\"javascript:void(0)\" onclick=\"detail('" + bankId + "');\" >查看</a>&nbsp;&nbsp<a href=\"javascript:void(0)\" onclick=\"detailRecord('" + bankId + "');\" >来往记录</a></center>";
...
function detailRecord(bankId){
	window.location.href='bankRecord.jsp?bankId='+bankId;
}
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
 <tr>
   <td class="Big" colspan="2" align="center">
